...
abstract class C2C_Plugin_023 {
	...
	public function __construct( $version, $id_base, $author_prefix, $file, $plugin_options = array() ) {
		...
		$defaults = array(
			...
			'disable_contextual_help' => true,						// Prevent overriding of the contextual help?
			'disable_update_check'	=> true,						// Prevent WP from checking for updates to this plugin?
	...
	public function add_c2c_admin_css() {
		...
		$logo = plugins_url( 'anatta.png', $this->plugin_file );
		/**
